...
public class CaptureScreenshotUtil {
	...
	public static String captureScreen(WebDriver driver) {
		...
		try {
			...
			destScreenFilePath = System.getProperty("user.dir") + File.separator+ "reports"+ File.separator + "screens"+ File.separator + "ExceptionScreen_"+ System.currentTimeMillis() + ".png";
